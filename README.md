...
Manual creation
- Bucket URL: https://nodejs-aws-shop-react-tds.s3.eu-west-3.amazonaws.com/
- CloudFront URL: https://d33vo0g8fydqmn.cloudfront.net/

I have let the "manual" bucket accessible even if the task asked us to set a 403 because I wanted to
show that it worked (buckel url + cloudfront URL). As you will see below I did this on the "automatic"
bucket creation, this last is not accessible.
